...
namespace Proxies\__CG__\BIJI\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \BIJI\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'tasks', '' . "\0" . 'BIJI\\UserBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'BIJI\\UserBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'BIJI\\UserBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'BIJI\\UserBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'BIJI\\UserBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'BIJI\\UserBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'BIJI\\UserBundle\\Entity\\User' . "\0" . 'role', '' . "\0" . 'BIJI\\UserBundle\\Entity\\User' . "\0" . 'isActive', '' . "\0" . 'BIJI\\UserBundle\\Entity\\User' . "\0" . 'createdAt', '' . "\0" . 'BIJI\\UserBundle\\Entity\\User' . "\0" . 'updatedAt'];
        }
